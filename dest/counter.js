...
var CountApp = React.createClass({displayName: "CountApp",
	getInitialState : function (){
		return { counter: 0 };
	},
...
var Counter = React.createClass({displayName: "Counter",
	...
	render: function () {
		return (
			React.createElement("div", null, 
				React.createElement("span", null, "count: ", this.props.value), 
				React.createElement("div", null, 
					React.createElement("button", {onClick: this.props.onClickPlus}, 
					"+1"
					), 
					React.createElement("button", {onClick: this.props.onClickMinus}, 
					"-1"
					)
				)
			)
...
React.render(
	React.createElement(CountApp, null),
